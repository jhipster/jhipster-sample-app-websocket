...
export class AlertErrorComponent implements OnDestroy {
  ...
  constructor(
    ...
    this.errorListener = eventManager.subscribe(
      'jhipsterWebsocketSampleApplicationApp.error',
    ...
    this.httpErrorListener = eventManager.subscribe(
      'jhipsterWebsocketSampleApplicationApp.httpError',
      (response: EventWithContent<unknown> | string) => {
            ...
            if (errorHeader) {
              ...
              for (const fieldError of fieldErrors) {
                ...
                const fieldName: string = translateService.instant(
                  `jhipsterWebsocketSampleApplicationApp.${fieldError.objectName as string}.${convertedField}`,
                );
