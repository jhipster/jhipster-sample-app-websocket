(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('jhipsterWebsocketSampleApplicationApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-jhipsterWebsocketSampleApplicationApp-error');
                var entityKey = httpResponse.headers('X-jhipsterWebsocketSampleApplicationApp-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('jhipsterWebsocketSampleApplicationApp.' + fieldError.objectName + '.' + convertedField);
